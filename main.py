...
def main():
    current = 'MALL CENTER'  # The starting location
    end_game = ['CLOSER']  # Any of the end-game locations
    end_game = ['MOM']
    moves = 0
    points = 0
    ...
    print("You scored {} points {} moves".format(points,moves))
